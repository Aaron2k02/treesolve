    ...
    <div class="container main-container">
            ...
            <div class="main-right">
                ...
                <form class="register__form" action="update.php" method="post">
                    ...
                    <input type="text" name="user_id" required value="<?php echo $user_id ?>">
                    <input type="text" name="forum_title" required value="<?php echo $forum_title ?>">
                    <input type="text" name="forum_image_path" required value="<?php echo $forum_image_path ?>">

                    <textarea name="forum_content" rows = "7" placeholder="Content" required><?php echo $forum_content ?></textarea>
