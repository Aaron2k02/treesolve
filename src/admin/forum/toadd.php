    ...
    <div class="container main-container">
            ...
            <div class="main-right">
                ...
                <form class="register__form" action="add.php" method="post">
                    ...
                    <input type="text" name="forum_title" required placeholder="Title">
                    <input type="text" name="forum_image_path" required placeholder="Image Path">

                    <textarea name="forum_content" rows = "7" placeholder="Content" required></textarea>
